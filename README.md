# Foundry Dynamic SVG NFT & IPFS Hosted NFT

This is a learning project focussed on Smart Contract development & testing with Foundry.
...
```
git clone https://github.com/shobhit-gupta/dynamic-svg-nft
cd dynamic-svg-nft
forge install
forge build
```
...
We focus on the following 4 test tiers in the repo:
